                                                ...
                                                <td class="text-center" :class="datalist.class" v-if="showOpsi">
                                                    <button type="button"
                                                        v-if="datalist.level == 'ISP' && ((!leveluser.includes(1) && (!leveluser.includes(2))))
                                                            ...
                                                            && (jenis_piusistem != 42) && (jenis_piusistem != 43) && (jenis_piusistem != 44) && (!hasilakhir.includes('Selesai'))"
                                                    ...
                                                    <button type="button"
                                                        v-if="datalist.level == 'ISP' && ((!leveluser.includes(1) && (!leveluser.includes(2))))
                                                            && (jenis_piusistem != 34) && (jenis_piusistem != 36) && (jenis_piusistem != 37) && (jenis_piusistem != 38)
                                                            && (jenis_piusistem != 42) && (jenis_piusistem != 43) && (jenis_piusistem != 44) && (hasilakhir.includes('Selesai'))"
                                                        class="btn btn-success lebar4 btn-sm text-white"
                                                        style="font-size: smaller !important;"
                                                        @click="lihatdetail(datalist.id, datalist.hitungan_pk)"
                                                        data-toggle="tooltip" data-placement="left"
                                                        title="Cek data.."><i class="far fa-check-circle"></i>
                                                        <span> Cek Detail</span></button>
                                                    <button type="button"
                                                        v-if="(datalist.level == 'ISP') && ((leveluser.includes(1) || (leveluser.includes(2)))
                                                            || (jenis_piusistem == 34) || (jenis_piusistem == 36) || (jenis_piusistem == 37) || (jenis_piusistem == 38)
...
export default {
    ...
    methods: {
        ...
        async verifpk() {
            ...
            //alert(jenis_satker);
            await mainAPI.get("pksatkerawal-DataVerif?random=" + random + "&kode_satker=" + kode_satker + "&tahun=" + this.selectedtahun + "&pelaksana=" + jenis_satker).then(
                Response => {
                    this.datapesanreff = Response.data.message;
                    if (this.datapesanreff == 'data diketemukan') {
                        ...
                        document.getElementById('iframefileverifikasi').src = process.env.VUE_APP_URL_API + this.tahunku + '/' + "pkbalaiawal-cetakPK?kodebalai=" + btoa(pelaksana) + "&tahun=" + btoa(this.selectedtahun) + "&pelaksana=" + btoa(pelaksana);
        ...
        lihatdetail(id, hitungan_pk) {
            ...
            if (this.hitungan_pk == 1) {
                var random = Math.random();
                mainAPI.get("pkbalaiawal-GetBaseline?random=" + random + "&tahun=" + this.selectedtahun + "&id=" + this.id + "&kdbalai=" + this.selectedkategorisatker + "&hitungan_pk=" + this.hitungan_pk).then(
                    Response => {
                ...
                var random = Math.random();
                mainAPI.get("pkbalaiawalhitungan-GetBaseline?random=" + random + "&tahun=" + this.selectedtahun + "&id=" + this.id + "&kdbalai=" + this.selectedkategorisatker + "&hitungan_pk=" + this.hitungan_pk).then(
                    Response => {
                        this.datapesan = Response.data.message;
                        if (this.datapesan == 'data diketemukan') {
                            this.isiandata = [];
        ...
        cetakpk() {
            ...
            //alert(process.env.VUE_APP_URL_API+this.tahunku+'/' + foldernya + '?f=' + filenya);
            if (kategorisatker == 1) {
                document.getElementById('iframefile').src = process.env.VUE_APP_URL_API + this.tahunku + '/' + "pkdirjenawal-cetakPK?kodebalai=" + btoa(kategorisatker) + "&tahun=" + btoa(this.selectedtahun);
            }
            else {
                document.getElementById('iframefile').src = process.env.VUE_APP_URL_API + this.tahunku + '/' + "pkbalaiawal-cetakPK?kodebalai=" + btoa(kategorisatker) + "&tahun=" + btoa(this.selectedtahun);
            }
        ...
        simpan() {
            ...
            var adi = this.selectedkategorisatker.replaceAll("_", "");
            var fix = adi.replaceAll("undefined", "");

            var fd = new FormData();
            fd.append("id_indikator", this.id);
            fd.append("id_balai", fix);
            ...
            mainAPI.post("pkbalaiawal-Update", fd).then(
                Response => {
                    ...
                    if (Response.data.response == 'error') {
                        swal.fire('Peringatan', Response.data.message, 'error');
                        window.location.replace("/PerjanjianKinerjaBalaiAwal/" + kode);
                        $('.swal2-container').css("z-index", '999999');
                    }
                    else {
        ...
        async ambildata() {
            ...
            await mainAPI.get("pkbalaiawal-GetData?random=" + random + "&tahun=" + this.selectedtahun + "&kodebalai=" + kategorisatker).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
                        this.datamaster = [];
            ...
            this.halamanloading = true;
            var random = Math.random();
            await mainAPI.get("pkbalaiawal-GetTTD?random=" + random + "&kode_satker=" + kategorisatker).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
