                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6 wow fadeInDown">
                            <h5>Daftar Paket Kontraktual</h5>
                        </div>
                        <div class="col-sm-6 wow fadeInDown">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="/Dashboard">Beranda </a></li>
                                <li class="breadcrumb-item active">Daftar Paket Kontraktual</li>
                            </ol>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                ...
                                <table class="table m-0" id="tabeldata" style="font-size: x-small;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 50px;">Pagu RM<br></br>(Rp Ribu)</th>
                                            <th style="width: 50px;">Pagu PHLN<br></br>(Rp Ribu)</th>
                                            <th style="width: 50px;">Pagu SBSN<br></br>(Rp Ribu)</th>
                                            <th style="width: 50px;">Pagu Efektif<br></br>(Rp Ribu)</th>
                                            <th style="width: 50px;">Blokir<br></br>(Rp Ribu)</th>
                                            <th style="width: 100px;">Status Kontrak</th>
                                            <th style="width: 100px;">Nilai Kontrak Induk<br></br>(Rp Ribu)</th>
                                            <th style="width: 100px;">Nilai Kontrak Anak<br></br>(Rp Ribu)</th>
                                        </tr>
                                    </thead>
                                    <template v-for="(datalist, urutlist) in filteredKataData" :key="urutlist">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td :class="datalist.class" class="text-center" :data-v="datalist.kode">
                                                    {{ datalist.kode }}
                                                </td>
...
export default {
    ...
    methods: {
        ...
        async ambildata() {
            ...
            var random = Math.random();
            await mainAPI.get("cek_emon-Kontraktual?random=" + random + "&tahun=" + this.selectedtahun + "&kode_satker=" + this.selectedsatker + "&kdgiat=" + this.selectedkegiatan + "&kdoutput=" + this.selectedklasifikasirincianoutput + "&kdsoutput=" + this.selectedrincianoutput).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
