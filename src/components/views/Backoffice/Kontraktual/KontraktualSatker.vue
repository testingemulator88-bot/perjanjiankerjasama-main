                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 wow fadeInDown">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Rekap Satker</li>
                            </ol>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                        ...
                                        <table class="table m-0" id="tabeldata" style="font-size: x-small;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 150px;" rowspan="3" v-if="showBalai">Satker</th>
...
export default {
    ...
    methods: {
        ...
        lihatdata(idbalai, kodesatker) {
            ...
            window.location.replace("/DetailPaket/" + bytes);
        },
        ontahunChange(a) {
            try {
        ...
        async ambildata() {
            ...
            await mainAPI.get("kontraktual_emon-GetSatkerSDA?random=" + random + "&tahun=" + this.selectedtahun + "&balai=" + this.selectedkategorisatker).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
