                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 wow fadeInDown">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Pengaturan Satuan</li>
                            </ol>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-sm-12 wow fadeInDown">
                            <div class="card cardputih">
                                <div class="card-header border-transparent">
                                    <h3 class="card-title">Form Input Satuan</h3>
                                ...
                                <div class="card-body p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <label>Singkatan Satuan <small class="text-info"> (*wajib
                                                    diisi)</small></label>
                                            <div class="input-group mb-3">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text"><i
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="singkatan"
                                                    name="singkatan" placeholder="Singkatan Satuan" v-model="singkatan">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            &nbsp;
...
export default {
    ...
    methods: {
        ...
        batalproses() {
            window.location.replace("/Satuan");
        },
        async AmbilDataSingel() {
            ...
            await mainAPIDataSingel.get("parastapainnovationsatuan-GetByID?id=" + this.secretencData + "&random=" + random).then(
                Response => {
                    this.nama = Response.data.content.data[0].nama;
                    this.singkatan = Response.data.content.data[0].singkatan;
                    this.halamanloading = false;
                }
            ).catch(error => {
        ...
        validasidata() {
            ...
            if (document.getElementById('nama').value == '') {
                swal.mixin({
                    ...
                    icon: 'warning',
                    title: 'Mohon Isikan Nama Satuan',
                });
            ...
            if (document.getElementById('singkatan').value == '') {
                swal.mixin({
                    ...
                    icon: 'warning',
                    title: 'Mohon Isikan Singkatan Satuan',
                });
        ...
        simpan() {
            ...
            fd.append("singkatan", this.singkatan);
            ...
            mainAPI.post("parastapainnovationsatuan-Add", fd).then(
                Response => {
        ...
        update() {
            ...
            mainAPI.post("parastapainnovationsatuan-Update", fd).then(
                Response => {
                    if (Response.data.response == 'error') {
                        swal.fire('Peringatan', Response.data.message, 'error');
                    }
