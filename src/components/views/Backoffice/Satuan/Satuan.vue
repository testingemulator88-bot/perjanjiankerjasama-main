                                    ...
                                    <div class="col-sm-12 float-left pb-2 px-3">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" v-model="carikata" class="form-control form-control-sm"
                                                placeholder="Masukkan Kata Kunci Pencarian Nama Satuan"
                                                @keyup="ambildata()">
                                        </div>
                                    </div>
                                        ...
                                        <table class="table m-0" id="tabeldata">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 250px;">Singkatan</th>
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <span v-html="datalist.singkatan"></span>
                                                        </td>
                                                        <td class="text-center">
                                                            <button type="button"
...
export default {
    ...
    methods: {
        ...
        async pindahhalaman(halamannya) {
            ...
            await mainAPI.get("parastapainnovationsatuan-GetData?random=" + random + "&halaman=" + halamannya + "&cari=" + this.carikata).then(
                Response => {
        ...
        async ambildata() {
            ...
            var random = Math.random();
            await mainAPI.get("parastapainnovationsatuan-GetData?random=" + random + "&halaman=" + this.halaman + "&cari=" + this.carikata).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
                        this.datamaster = [];
        ...
        prosesdata(kode) {
            ...
            window.location.replace("/ProsesSatuan/" + bytes);
        },
        hapus(kode) {
            swal.fire({
                title: "Konfirmasi",
                ...
                if (result.isConfirmed) {
                    ...
                    mainAPI.post("parastapainnovationsatuan-Delete", data).then(
                        Response => {
