                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6 wow fadeInDown">
                            <h5>Resume Target PK Awal B/BWS</h5>
                        </div>
                        <div class="col-sm-6 wow fadeInDown">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="/Dashboard">Beranda </a></li>
                                <li class="breadcrumb-item active">Resume Target PK Awal B/BWS</li>
                            </ol>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                    ...
                                    <template v-for="(datalist, urutlist) in datamaster" :key="urutlist">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td :class="datalist.class" colspan="3">
...
export default {
    ...
    methods: {
        async eksportresumepk(namefile) {
            ...
            var paramurl = "";
            paramurl = "EksportExcelPKAwal-Balai?random=" + random + "&tahun=" + this.selectedtahun + "&kodebalai=" + kategorisatker;
        ...
        async ambildata() {
            ...
            await mainAPI.get("DataAkhirPKAwal-Target?random=" + random + "&tahun=" + this.selectedtahun + "&kodebalai=" + kategorisatker).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
                        this.datamaster = [];
