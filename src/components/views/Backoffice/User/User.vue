                                        ...
                                        <table class="table m-0" id="tabeldata">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 150px;">Pusat / Balai</th>
...
export default {
    ...
    methods: {
        ...
        async ambildata() {
            ...
            await mainAPI.get("parastapainnovation-GetAllUser?random=" + random + "&level=" + this.leveluser).then(
                Response => {
        ...
        prosesdata(kode) {
            ...
            window.location.replace("/ProsesUser/" + bytes);
        },
        hapus(kode) {
            swal.fire({
                title: "Konfirmasi",
                ...
                if (result.isConfirmed) {
                    ...
                    mainAPI.post("parastapainnovationuser-DeleteUser", data).then(
                        Response => {
