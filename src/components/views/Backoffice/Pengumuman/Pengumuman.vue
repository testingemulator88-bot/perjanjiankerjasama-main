                                    ...
                                    <div class="col-sm-12 float-left pb-2 px-3">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" v-model="carikata" class="form-control form-control-sm"
                                                placeholder="Masukkan Kata Kunci Pencarian Nama Pengumuman"
                                                @keyup="ambildata()">
                                        </div>
                                    </div>
                                        ...
                                        <table class="table m-0" id="tabeldata">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 450px;">Pengumuman</th>
...
export default {
    ...
    methods: {
        ...
        async pindahhalaman(halamannya) {
            ...
            await mainAPI.get("parastapainnovationpengumuman-GetData?random=" + random + "&halaman=" + halamannya + "&cari=" + this.carikata).then(
                Response => {
        ...
        async ambildata() {
            ...
            var random = Math.random();
            await mainAPI.get("parastapainnovationpengumuman-GetData?random=" + random + "&halaman=" + this.halaman + "&cari=" + this.carikata).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
                        this.datamaster = [];
        ...
        prosesdata(kode) {
            ...
            window.location.replace("/ProsesPengumuman/" + bytes);
        },
        hapus(kode) {
            swal.fire({
                title: "Konfirmasi",
                ...
                if (result.isConfirmed) {
                    ...
                    mainAPI.post("parastapainnovationpengumuman-Delete", data).then(
                        Response => {
