        ...
        <div class="modal fade" id="costumModalopsi" data-easein="flipBounceYIn" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog modal-fullscreen">
                <div class="modal-content">
                                                    ...
                                                    <tr :id="'baris' + emon.id">
                                                        ...
                                                        <template v-for="(nilaiemon, urutnilaiemon) in emon.nilai"
                                                            ...
                                                            <td class="text-center"
                                                                ...
                                                                <input type="text" class="form-control form-control-sm"
                                                                    :disabled="nilaiemon.disabled || disabelkolomnya || emon.tahun != tahunsekarang"
                                                        ...
                                                        <td class=""
                                                            ...
                                                            <input type="number" class="form-control form-control-sm"
                                                                ...
                                                                :value="emon.latitude" :disabled="emon.tahun != tahunsekarang || disabelkolomnya"
                                                                style="border: solid 1px #778899;height: 20px !important;font-size: 11px !important;"
                                                            ...
                                                            <input type="number" class="form-control form-control-sm"
                                                                ...
                                                                :value="emon.longitude" :disabled="emon.tahun != tahunsekarang || disabelkolomnya"
                                                                style="border: solid 1px #778899;height: 20px !important;font-size: 11px !important;"
                    ...
                    <div class="modal-footer">
                        <div class="col-sm-12 text-center">
                            <button type="button" class="btn btn-primary btn-sm lebar2 text-white" @click.once="simpan()"
                                :disabled="disabelkolomnya">
                                <i class="fas fa-plus-square"></i>
                                Simpan
                            </button>
                                            ...
                                            <tr>
                                                ...
                                                <td :class="datalist.class" v-if="showOpsi" class="text-center">
                                                    <input type="checkbox" :checked="datalist.terpilih == 0"
                                                        ...
                                                        :disabled="hasilakhir == 'VerifikasiTempSelesai Selesai'"
...
export default {
    ...
    data() {
        return {
            ...
            nama: '',
            urut: 1,
            tahun: JSON.parse(localStorage.getItem("tahunpkawal")),
            tahunsekarang: JSON.parse(localStorage.getItem("tahunpkawal")),
            kdunor: [],
            datakdunor: [],
    ...
    methods: {
        ...
        hapusmultitaggingemon() {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    mainAPI.post("pksatkerawal-HapusMultiTagging", data).then(
                        Response => {
            ...
            if (document.getElementById(id).checked == false) {
                swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        mainAPI.post("indikatorAwal-SetActive", data).then(
                            Response => {
                                if (Response.data.response == 'error') {
                                    swal.fire('Peringatan', Response.data.message, 'error');
                                }
        ...
        async simpanverivikasi() {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    mainAPI.post("pksatkerawal-VerifUpdate", data).then(
                        Response => {
                            ...
                            if (Response.data.response == 'error') {
                                ...
                                if ((this.id_pelaksana_verif == '2') && (this.selectedverifikasi == '1') && (this.dari == '43')) {
                                    ...
                                    mainAPI2.post("pksatkerawal-VerifUpdate", data2).then(
                                        Response => {
                                            if (Response.data.response == 'error') {
                                                swal.fire('Peringatan', Response.data.message, 'error');
                                            }
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (dari == 42 && kepada == 2) {
                        ...
                        mainAPI.post("pksatkerawal-AjukanKeIrwaVerif", data).then(
                            Response => {
                        ...
                        mainAPI.post("pksatkerawal-AjukanKeSupanVerif", data).then(
                            Response => {
                                if (this.leveluser.includes(3) || this.leveluser.includes(4) || this.leveluser.includes(9) || this.leveluser.includes(8)) {
                                    var kode = encodeURIComponent(CryptoJS.AES.encrypt(this.secretencData, 'GPMop8LQ06S0rZXcJyEH3wk8jVrINbHwn7tBq2').toString());
                                }
                        ...
                        mainAPI.post("pksatkerawal-AjukanVerif", data).then(
                            Response => {
                                if (this.leveluser.includes(3) || this.leveluser.includes(4) || this.leveluser.includes(9) || this.leveluser.includes(8)) {
                                    var kode = encodeURIComponent(CryptoJS.AES.encrypt(this.secretencData, 'GPMop8LQ06S0rZXcJyEH3wk8jVrINbHwn7tBq2').toString());
                                }
        ...
        async verifpk() {
            ...
            if ((this.verifsistem != null && this.verifsistem.includes(pelaksana)) && this.leveluser != 1) {
                ...
                await mainAPI.get("pksatkerawal-DataVerif?random=" + random + "&kode_satker=" + kode_satker + "&tahun=" + this.selectedtahun + "&pelaksana=" + pelaksana).then(
                    Response => {
                        ...
                        if (this.datapesanreff == 'data diketemukan') {
                            ...
                            document.getElementById('iframefile').src = process.env.VUE_APP_URL_API + this.tahunku + '/' + "pksatkerawal-cetakPK?kode_satker=" + btoa(kode_satker) + "&tahun=" + btoa(this.selectedtahun) + "&pelaksana=" + btoa(pelaksana);
        ...
        cetakpk() {
            ...
            //alert(process.env.VUE_APP_URL_API+this.tahunku+'/' + foldernya + '?f=' + filenya);
            document.getElementById('iframefilecetak').src = process.env.VUE_APP_URL_API + this.tahunku + '/' + "pksatkerawal-cetakPK?kode_satker=" + btoa(kode_satker) + "&tahun=" + btoa(this.selectedtahun) + "&pelaksana=" + btoa(pelaksana);
        ...
        ubahisian_outcome_target_persen(id, kolom, idisian, tahun, jumlah, urutan) {
            ...
            mainAPI.post("pksatkerawalpersen-LatLongUpdate", data).then(
                Response => {
        ...
        ubahisian_outcome_target(id, kolom, idisian, tahun) {
            ...
            mainAPI.post("pksatkerawal-LatLongUpdate", data).then(
                Response => {
                    if (kolom == 'outcome') {
        ...
        hapustaggingemon(id) {
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    mainAPI.post("pksatkerawal-DeleteTagging", data).then(
                        Response => {
                            if (Response.data.response == 'error') {
                                swal.fire('Peringatan', Response.data.message, 'error');
                            }
        ...
        async bukaemon(id, tahun, kodesatker, kodekegiatan) {
            ...
            var random = Math.random();
            await mainAPI.get("pksatkerawal-GetEmon?random=" + random + "&id=" + id + "&kodesatker=" + kodesatker + "&tahun=" + tahun + "&kodekegiatan=" + kodekegiatan).then(
                Response => {
        ...
        async ambildata() {
            ...
            await mainAPI.get("pksatkerawal-GetData?random=" + random + "&tahun=" + this.selectedtahun + "&pelaksana=" + pelaksana + "&kode_satker=" + kode_satker).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
                        this.datamaster = [];
            ...
            this.halamanloading = true;
            var random = Math.random();
            await mainAPI.get("pksatkerawal-GetTTD?random=" + random + "&kode_satker=" + kode_satker).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
        ...
        prosesdata(id, namasatuan, namaoutput, namaoutcome, hitungan_pk, textindikator, jumlahkomponen, kolomkomponen, bobotkomponen, rumuskomponen, disabelkolomnya) {
            ...
            //alert(this.id);
            //alert(kode_satker);
            mainAPI.get("pksatkerawal-GetBaseline?random=" + random + "&tahun=" + this.selectedtahun + "&id=" + this.id + "&kode_satker=" + kode_satker + "&hitungan_pk=" + this.hitungan_pk + "&textindikator=" + this.textindikator).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
                        this.isiandata = [];
        ...
        pilihemon() {
            ...
            mainAPI.post("pksatkerawal-TaggingEmon", fd).then(
                Response => {
        ...
        simpanttd() {
            ...
            mainAPI.post("pksatkerawal-SimpanTTD", fd).then(
                Response => {
                    if (Response.data.response == 'error') {
                        swal.fire('Peringatan', Response.data.message, 'error');
                    }
        ...
        simpan() {
            ...
            setTimeout(() => {
                if (this.hitungan_pk == 1) {
                    ...
                    mainAPI.post("pksatkerawal-Update", fd).then(
                        Response => {
