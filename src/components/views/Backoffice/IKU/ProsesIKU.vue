                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 wow fadeInDown">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Pengaturan IKU</li>
                            </ol>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-sm-12 wow fadeInDown">
                            <div class="card cardputih">
                                <div class="card-header border-transparent">
                                    <h3 class="card-title">Form Input IKU</h3>
                                ...
                                <div class="card-body p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            <label>SASARAN KEGIATAN <small class="text-info"> (*wajib
                                                    diisi)</small></label>
                                            <quill-editor v-model:value="SASARANPROGRAM"
                                        ...
                                        <div class="col-sm-12">
                                            <label>INDIKATOR KINERJA <small class="text-info"> (*wajib
                                                    diisi)</small></label>
                                            <quill-editor v-model:value="INDIKATORKINERJA"
                                                style="height: 25vh;"></quill-editor>
                                        </div>
                                        <div class="col-sm-12">
                                            &nbsp;
                                        ...
                                        <div class="col-sm-12">
                                            <label>METODE PERHITUNGAN INDIKATOR KINERJA <small class="text-info">
                                                    (*wajib
                                                    diisi)</small></label>
                                            <quill-editor v-model:value="METODE" style="height: 25vh;"></quill-editor>
                                        </div>
                                        <div class="col-sm-12">
                                            &nbsp;
                                        </div>
...
export default {
    ...
    methods: {
        ...
        async AmbilDataSingel() {
            ...
            await mainAPIDataSingel.get("parastapainnovationiku-GetByID?id=" + this.secretencData + "&random=" + random).then(
                Response => {
                    this.KODE = Response.data.content.data[0].KODE;
                    this.SASARANPROGRAM = this.Dekriptext(Response.data.content.data[0].SASARANPROGRAM);
                    this.INDIKATORKINERJA = this.Dekriptext(Response.data.content.data[0].INDIKATORKINERJA);
                    this.METODE = this.Dekriptext(Response.data.content.data[0].METODE);
                    this.halamanloading = false;
                }
            ).catch(error => {
        ...
        validasidata() {
            ...
            if (this.SASARANPROGRAM == '') {
                swal.mixin({
                    ...
                    icon: 'warning',
                    title: 'Mohon Isikan Sasaran',
                });
                return false;
            }
            if (this.INDIKATORKINERJA == '') {
                swal.mixin({
                    toast: true,
                    position: 'top-end',
                    showConfirmButton: false,
        ...
        simpan() {
            ...
            fd.append("SASARANPROGRAM", this.SASARANPROGRAM);
            fd.append("INDIKATORKINERJA", this.INDIKATORKINERJA);
            fd.append("METODE", this.METODE);
            ...
            mainAPI.post("parastapainnovationiku-Add", fd).then(
                Response => {
        ...
        update() {
            ...
            mainAPI.post("parastapainnovationiku-Update", fd).then(
                Response => {
                    if (Response.data.response == 'error') {
                        swal.fire('Peringatan', Response.data.message, 'error');
                    }
