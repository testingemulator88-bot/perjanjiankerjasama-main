                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 wow fadeInDown">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="/Unor">Unit Organisasi</a></li>
                                <li class="breadcrumb-item active">Pengaturan Unit Organisasi</li>
                            </ol>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-sm-12 wow fadeInDown">
                            <div class="card cardputih">
                                <div class="card-header border-transparent">
                                    <h3 class="card-title">Form Input Unit Organisasi</h3>
...
export default {
    ...
    methods: {
        ...
        simpan() {
            ...
            mainAPI.post("parastapainnovationunor-Add", fd).then(
                Response => {
