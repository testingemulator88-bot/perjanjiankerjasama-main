...
export default {
    ...
    methods: {
        ...
        async ambildata() {
            ...
            var random = Math.random();
            await mainAPI.get("indikatorAkhir-GetData?random=" + random + "&tahun=" + this.selectedtahun).then(
                Response => {
            ...
            if (this.mode != 'Tambah') {
                swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        mainAPI.post("indikatorAkhir-Add", fd).then(
                            Response => {
                                if (Response.data.response == 'error') {
                                    ...
                                    swal.fire('Informasi', 'Data telah tersimpan..', 'success').then(function () {
                                        window.location.replace("/IndikatorAkhir");
                                    });
                                }
                            }
