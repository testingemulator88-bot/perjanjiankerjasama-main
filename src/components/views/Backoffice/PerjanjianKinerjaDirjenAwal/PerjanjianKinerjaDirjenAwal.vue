                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6 wow fadeInDown">
                            <h5>Perjanjian Kinerja Dirjen SDA</h5>
                        </div>
                        <div class="col-sm-6 wow fadeInDown">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="/Dashboard">Beranda </a></li>
                                <li class="breadcrumb-item active">Perjanjian Kinerja Dirjen SDA</li>
                            </ol>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm-12 wow fadeInDown"
                            v-if="datamaster.length > 0 && ((this.jenis_piusistem != 34) && (this.jenis_piusistem != 36)
                                ...
                                && (this.jenis_piusistem != 43) && (this.jenis_piusistem != 32) && (this.jenis_piusistem != 44))">
                            <div class="card cardputih collapsed-card">
                                <div class="card-header border-transparent bg-white" data-card-widget="collapse"
                                    style="cursor: pointer;">
                                            ...
                                            <tr>
                                                <td class="text-center" :class="datalist.class" v-if="showOpsi">
                                                    <button type="button"
                                                        ...
                                                        :disabled="hasilakhir == 'Verifikasi Selesai' && shortcutinput == '0'"
                                                ...
                                                <td :class="datalist.class" v-if="showOpsi" class="text-center">
                                                    <input type="checkbox" :checked="datalist.terpilih == 0"
                                                        :disabled="hasilakhir == 'Verifikasi Selesai' && shortcutinput == '0'"
                                                        v-if="(datalist.level == 'ISP' || datalist.level == 'SP') && (leveluser.includes(3))"
    ...
    methods: {
            ...
            await mainAPI.get("pksatkerawal-DataVerif?random=" + random + "&kode_satker=" + kode_satker + "&tahun=" + this.selectedtahun + "&pelaksana=" + jenis_satker).then(
                Response => {
                    ...
                    if (this.datapesanreff == 'data diketemukan') {
                        ...
                        document.getElementById('iframefileverifikasi').src = process.env.VUE_APP_URL_API + this.tahunku + '/' + "pkdirjenawal-cetakPK?kodebalai=" + btoa(pelaksana) + "&tahun=" + btoa(this.selectedtahun) + "&pelaksana=" + btoa(pelaksana);
        ...
        lihatdetail(id, hitungan_pk) {
            ...
            if (this.hitungan_pk == 1) {
                var random = Math.random();
                mainAPI.get("pkdirjenawal-GetBaseline?random=" + random + "&tahun=" + this.selectedtahun + "&id=" + this.id + "&kdbalai=" + this.selectedkategorisatker + "&hitungan_pk=" + this.hitungan_pk).then(
                    Response => {
                ...
                var random = Math.random();
                mainAPI.get("pkdirjenawalhitungan-GetBaseline?random=" + random + "&tahun=" + this.selectedtahun + "&id=" + this.id + "&kdbalai=" + this.selectedkategorisatker + "&hitungan_pk=" + this.hitungan_pk).then(
                    Response => {
                        this.datapesan = Response.data.message;
                        if (this.datapesan == 'data diketemukan') {
                            this.isiandata = [];
        ...
        simpan() {
            ...
            mainAPI.post("pkdirjenawal-Update", fd).then(
                Response => {
                    ...
                    if (Response.data.response == 'error') {
                        ...
                        swal.fire('Informasi', 'Data telah tersimpan..', 'success').then(function () {
                            window.location.replace("/PerjanjianKinerjaAwal/" + kode);
                        });
                    }
                }
            ).catch(function (error) {
        ...
        simpanttd() {
            ...
            var fd = new FormData();
            fd.append("level_pejabat", 'Dirjen');
        ...
        async ambildata() {
            ...
            await mainAPI.get("pkdirjenawal-GetData?random=" + random + "&tahun=" + this.selectedtahun + "&kodebalai=" + kategorisatker).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
                        this.datamaster = [];
            ...
            this.halamanloading = true;
            var random = Math.random();
            await mainAPI.get("pkdirjenawal-GetTTD?random=" + random + "&kode_satker=" + kategorisatker).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
                        this.level_pejabat = 'Dirjen';
