                ...
                <div class="container-fluid">
                    <div class="row mb-2">
                        <div class="col-sm-6 wow fadeInDown">
                            <h5>Master Sub Komponen</h5>
                        </div>
                        <div class="col-sm-6 wow fadeInDown">
                            <ol class="breadcrumb float-sm-right">
                                <li class="breadcrumb-item"><a href="/Dashboard">Home </a></li>
                                <li class="breadcrumb-item active">Master Sub Komponen</li>
                            </ol>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                        ...
                                        <table class="table m-0" id="tabeldata">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 100px;">Nama Komponen</th>
                                                    <th style="width: 100px;">Kode SubKomponen</th>
                                                    <th style="width: 150px;">Nama SubKomponen</th>
                                                    <th style="width: 150px;">Bobot SubKomponen</th>
                                            ...
                                            <template v-for="(datalist, urutlist) in filteredKataData" :key="urutlist">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            {{ datalist.kode_subkomponen }}
                                                        </td>
                                                        <td>
                                                            {{ datalist.nama_subkomponen }}
                                                        </td>
                                                        <td>
                                                            {{ datalist.bobot_subkomponen }}
                                                        </td>
                                                        <td class="text-center">
                                                            <button type="button"
                                                                class="btn btn-primary3 btn-sm lebar2 text-white"
                                                                @click="prosesdata(datalist.id_subkomponen)"
                                                                data-toggle="tooltip" data-placement="left"
                                                                title="Edit data.."><i class="fas fa-edit"></i> Edit
                                                                Data</button>
                                                            <button type="button"
                                                                class="btn btn-info3 btn-sm lebar2 text-white"
                                                                @click="hapus(datalist.id_subkomponen)"
                                                                data-toggle="tooltip" data-placement="left"
...
export default {
    ...
    methods: {
        ...
        async ambildata() {
            ...
            await mainAPI.get("masterlke-GetAllSubKomponen?random=" + random + "&level=" + this.leveluser).then(
                Response => {
        ...
        prosesdata(kode) {
            ...
            window.location.replace("/ProsesSubKomponen/" + bytes);
        },
        hapus(kode) {
            swal.fire({
                title: "Konfirmasi",
                ...
                if (result.isConfirmed) {
                    ...
                    mainAPI.post("masterlke-DeleteSubKomponen", data).then(
                        Response => {
