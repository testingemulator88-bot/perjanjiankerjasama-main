<template>
    <div class="wrapper">
                                ...
                                <div class="row" v-if="files.length">
                                    <div v-for="file in files" :key="file.name" class="row">
                                        <div class="col-sm-10 float-left">
                                            ...
                                            <input type="hidden" class="form-control form-control-sm" :value="file.name"
                                                :id="'nama_file' + files.indexOf(file)" placeholder="File Beranda">
                                        </div>
        ...
        <div class="modal fade" id="costumModalLihatBuktiDukung" data-easein="flipBounceYIn" tabindex="-1" role="dialog"
            aria-labelledby="costumModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false"
            style="background: rgba(240, 248, 255, 0.1);">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    <div class="modal-header bg-yellow">
                        <h4 class="modal-title">Lihat Bukti Dukung {{ opsi }}</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">&times;</span>
                        </button>
                    </div>
        ...
        <div class="modal fade" id="costumModalEditBuktiDukung" data-easein="flipBounceYIn" tabindex="-1" role="dialog"
            aria-labelledby="costumModalLabel" aria-hidden="true" data-backdrop="static" data-keyboard="false"
            style="background: rgba(240, 248, 255, 0.1);">
            <div class="modal-dialog modal-xl">
                <div class="modal-content">
                    ...
                    <div class="modal-body text-justify">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-12">
                                <div id="drag_drop3" @dragover="dragover3" @dragleave="dragleave3" @drop="drop3">
                                    Drag & Drop File Disini
                                </div>
                            </div>
                            <div class="col-sm-12">
                                <input type="file" multiple name="file" id="fileInput" class="hidden-input"
                                    @change="onChange3" ref="file3" accept="application/pdf" />
                                <br>
                                <div class="row" v-if="files3.length">
                                    <div v-for="file in files3" :key="file.name" class="row">
                                        <div class="col-sm-10 float-left" v-if="file.status == '100'">
                                            {{ file.nama_file_dok }}
                                            <input type="hidden" class="form-control form-control-sm" :value="file.dokumen"
                                                :id="'pic3' + files3.indexOf(file)" placeholder="File Beranda">

                                            <input type="hidden" class="form-control form-control-sm" :value="file.nama_file_dok"
                                                :id="'nama_file3' + files3.indexOf(file)" placeholder="File Beranda">
                                        </div>
                                        <div class="col-sm-10 float-left" v-else>
                                            {{ file.name }}
                                            <input type="hidden" class="form-control form-control-sm" :value="file.name"
                                                :id="'pic3' + files3.indexOf(file)" placeholder="File Beranda">
                                        ...
                                        <div class="col-sm-2 text-right">
                                            <button type="button" class="btn btn-sm btn-danger3 float-right text-white"
                                                @click="remove3(files3.indexOf(file))" data-toggle="tooltip"
                                                data-placement="left" title="Hapus file.."><i
                                                    class="fas fa-window-close"></i></button>
                                        </div>
                                        <div class="col-sm-12">
                                            <div class="progress" v-if="file.status == '100'">
                                                <div class="progress-bar" role="progressbar" aria-valuenow="0"
                                                    aria-valuemin="0" aria-valuemax="100" style="width:100%"
                                                    :id="'persennyapic3' + files3.indexOf(file)">
                                                    <span :id="'tulisanpersenpic3' + files3.indexOf(file)">100%</span>
                                                </div>
                                            </div>
                                            <div class="progress" v-else>
                                                <div class="progress-bar" role="progressbar" aria-valuenow="0"
                                                    aria-valuemin="0" aria-valuemax="100" style="width:0%"
                                                    :id="'persennyapic3' + files3.indexOf(file)">
                                                    <span :id="'tulisanpersenpic3' + files3.indexOf(file)">0%</span>
                                                </div>
                                            </div>
                                            <br>
                                            <span class="text-success"
                                                :id="'suksesnyapic3' + files3.indexOf(file)"></span>
                                        </div>
                                    </div>
                                    <div class="col-sm-12" v-if="files3.length">
                                        <button type="button"
                                            class="btn btn-sm btn-success float-left text-white lebar2"
                                            @click="upload3()" data-toggle="tooltip" data-placement="left"
                                            title="Update data..">
                                            <i class="fas fa-upload"></i> Upload Data
                                        </button>
                                    </div>
        ...
        <div class="content-wrapper py-3">
            ...
            <div class="content">
                <div class="container-fluid">
                    <div class="row wow fadeInDown" v-if="leveluser.includes(6) || leveluser.includes(8)">
                    ...
                    <div class="row">
                        <div class="col-sm-12 wow fadeInDown">
                            <div class="card cardputih">
                                ...
                                <div class="col-sm-12 wow fadeInDown"
                                    v-if="datamaster.length > 0 && leveluser.includes(1) || leveluser.includes(2)">
                                    &nbsp;</div>
                                <div class="col-sm-12 wow fadeInDown"
                                    v-if="datamaster.length > 0 && leveluser.includes(1) || leveluser.includes(2)">
                                ...
                                <div class="row">
                                    <div class="col-sm-11 text-center wow fadeInDown"
                                        v-if="leveluser.includes(1) || leveluser.includes(2)">
                                        <div class="btn-group" v-if="datamaster.length > 0">
                                        ...
                                        <button class="btn btn-success" @click="exportExcel()" data-toggle="tooltip"
                                            data-placement="top" title="Export Excel" v-if="datamaster.length > 0">
                                            <i class="fas fa-file-excel"></i> Export Excel
                                        </button>
                                    </div>

                                    <div class="col-sm-1 text-center py-2">
                                        <strong v-if="datamaster.length > 0">Skor LKE: {{ skor_lke }}</strong>
                                    </div>
                                </div>

                                <div class="col-sm-12 wow fadeInDown" v-if="datamaster.length > 0">
                                    &nbsp;
                                </div>
                                    ...
                                    <div class="table-responsive table-wrapper">
                                        <table class="table m-0" id="tabeldata" style="font-size: smaller;">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th colspan="5" style="width: 100px;"
                                                        v-if="leveluser.includes(1) || leveluser.includes(2) || leveluser.includes(4) || leveluser.includes(6) || leveluser.includes(8) || leveluser.includes(9) || jenis_piusistem.includes(21, 6, 31)">
                                                        Kriteria Penilaian
                                                    </th>
                                                    ...
                                                    <template
                                                        ...
                                                        <tr v-for="(datadetailkriteria, urutdetailkriteria) in datasubkomponen.detailKriteria"
                                                            ...
                                                            <td class="text-center" :rowspan="datasubkomponen.rowspan"
                                                                v-if="urutdetailkriteria == 0 && (leveluser.includes(1) || leveluser.includes(2) || leveluser.includes(4) || leveluser.includes(6) || leveluser.includes(8) || leveluser.includes(9) || jenis_piusistem.includes(21, 6, 31))">
                                                            ...
                                                            <td class="text-center">
                                                                <button type="button"
                                                                    v-if="datadetailkriteria.data_lke == '0' && (leveluser.includes(4) || leveluser.includes(6) || leveluser.includes(8) || leveluser.includes(9) || jenis_piusistem.includes(21, 6, 31)) && datadetailkriteria.status_lke == ''"
                                                                ...
                                                                <span v-if="datadetailkriteria.data_lke == '0' && (leveluser.includes(1) || leveluser.includes(2)) && datadetailkriteria.status_lke == ''">
                                                                    Data Belum Diinput
                                                                </span>

                                                                <button type="button"
                                                                    v-if="datadetailkriteria.data_lke == '0' && (leveluser.includes(1) || leveluser.includes(2)) && datadetailkriteria.status_lke == ''"
                                                                    class="btn btn-primary3 btn-sm lebar2 text-white"
                                                                    @click="prosesdata(datadetailkriteria.id_kriteria, datadetailkriteria.id_lke, 'NilaiIndikator')"
                                                                    data-toggle="tooltip" data-placement="left"
                                                                    title="Nilai Indikator..">
                                                                    <i class="fas fa-plus"></i> Nilai Indikator
                                                                </button>

                                                                <span
                                                                    v-if="datadetailkriteria.data_lke == '1' && (leveluser.includes(4) || leveluser.includes(6) || leveluser.includes(8) || leveluser.includes(9) || jenis_piusistem.includes(21, 6, 31)) && datadetailkriteria.status_lke == '1'">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <button type="button"
                                                                        v-if="datadetailkriteria.data_lke == '1' && (leveluser.includes(4) || leveluser.includes(6) || leveluser.includes(8) || leveluser.includes(9) || jenis_piusistem.includes(21, 6, 31)) && datadetailkriteria.status_lke == '1'"
                                                                        class="btn btn-warning btn-sm lebar2 text-white"
                                                                        @click="prosesdata(datadetailkriteria.id_kriteria, datadetailkriteria.id_lke, 'LihatBuktiDukung')"
                                                                        data-toggle="tooltip" data-placement="left"
                                                                        title="Lihat Bukti Dukung..">
                                                                        <i class="fas fa-eye"></i> Lihat Bukti Dukung
                                                                    </button>
                                                                </div>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <button type="button"
                                                                        ...
                                                                        @click="prosesdata(datadetailkriteria.id_kriteria, datadetailkriteria.id_lke, 'EditBuktiDukung')"
                                                                        data-toggle="tooltip" data-placement="left"
                                                                        title="Edit Bukti Dukung..">
                                                                        <i class="fas fa-edit"></i> Edit Bukti Dukung
                                                                    </button>
                                                                </div>
                                                                ...
                                                                <button type="button"
                                                                    v-if="datadetailkriteria.data_lke == '1' && (leveluser.includes(1) || leveluser.includes(2)) && datadetailkriteria.status_lke == '1'"
                                                                    class="btn btn-primary3 btn-sm lebar2 text-white"
                                                                ...
                                                                <button type="button"
                                                                    v-if="datadetailkriteria.data_lke == '1' && (leveluser.includes(4) || leveluser.includes(6) || leveluser.includes(8) || leveluser.includes(9) || jenis_piusistem.includes(21, 6, 31)) && datadetailkriteria.status_lke == '2'"
                                                                    class="btn btn-success btn-sm lebar2 text-white"
                                                                ...
                                                                <span
                                                                    v-if="datadetailkriteria.data_lke == '1' && (leveluser.includes(1) || leveluser.includes(2)) && isTanggapanDisabled(datadetailkriteria.tanggal_evaluasi) == false && datadetailkriteria.status_lke == '2'">
                                                                    <i class="fas fa-spinner"></i> Data sedang diproses
                                                                    Perbaikan oleh Balai
                                                                </span>

                                                                <span
                                                                    v-if="datadetailkriteria.data_lke == '1' && (leveluser.includes(1) || leveluser.includes(2)) && isTanggapanDisabled(datadetailkriteria.tanggal_evaluasi) == true && datadetailkriteria.status_lke == '2'">
                                                                    <i class="fas fa-times-circle"></i> Data tidak
                                                                    diperbaiki oleh Balai <br>

                                                                    <button type="button"
                                                                        v-if="datadetailkriteria.data_lke == '1' && (leveluser.includes(1) || leveluser.includes(2)) && datadetailkriteria.status_lke == '2'"
                                                                        class="btn btn-success btn-sm lebar2 text-white"
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <button type="button"
                                                                        v-if="datadetailkriteria.data_lke == '1' && (leveluser.includes(1) || leveluser.includes(2)) && datadetailkriteria.status_lke == '2'"
                                                                        class="btn btn-primary3 btn-sm lebar2 text-white"
                                                                        @click="prosesdata(datadetailkriteria.id_kriteria, datadetailkriteria.id_lke, 'ResetEvaluasiDataLKE')"
                                                                        data-toggle="tooltip" data-placement="left"
                                                                        title="Reset Evaluasi Data LKE..">
                                                                        <i class="fas fa-sync-alt"></i> Reset Evaluasi Data LKE
                                                                    </button>
                                                                </div>

                                                                <span
                                                                    v-if="datadetailkriteria.data_lke == '1' && (leveluser.includes(4) || leveluser.includes(6) || leveluser.includes(8) || leveluser.includes(9) || jenis_piusistem.includes(21, 6, 31)) && datadetailkriteria.status_lke == '3'">
                                                                    <i class="fas fa-spinner"></i> Data sedang diproses
                                                                    Evaluasi Ulang
                                                                </span>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <button type="button"
                                                                        v-if="datadetailkriteria.data_lke == '1' && (leveluser.includes(1) || leveluser.includes(2)) && datadetailkriteria.status_lke == '3'"
                                                                        class="btn btn-primary3 btn-sm lebar2 text-white"
                                                                        @click="prosesdata(datadetailkriteria.id_kriteria, datadetailkriteria.id_lke, 'ResetEvaluasiDataLKE')"
                                                                        data-toggle="tooltip" data-placement="left"
                                                                        title="Reset Evaluasi Data LKE..">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <button type="button"
                                                                        v-if="datadetailkriteria.data_lke == '1' && (leveluser.includes(1) || leveluser.includes(2) ||leveluser.includes(4) || leveluser.includes(6) || leveluser.includes(8) || leveluser.includes(9) || jenis_piusistem.includes(21, 6, 31)) && datadetailkriteria.status_lke == '4'"
                                                                        class="btn btn-warning btn-sm lebar2 text-white"
                                                                        @click="prosesdata(datadetailkriteria.id_kriteria, datadetailkriteria.id_lke, 'LihatBuktiDukung')"
                                                                        data-toggle="tooltip" data-placement="left"
                                                                        title="Lihat Bukti Dukung..">
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <button type="button"
                                                                        v-if="datadetailkriteria.data_lke == '1' && (leveluser.includes(1) || leveluser.includes(2)) && datadetailkriteria.status_lke == '4'"
                                                                        class="btn btn-primary3 btn-sm lebar2 text-white"
                                                                        @click="prosesdata(datadetailkriteria.id_kriteria, datadetailkriteria.id_lke, 'ResetEvaluasiDataLKE')"
                                                                        data-toggle="tooltip" data-placement="left"
                                                                        title="Reset Evaluasi Data LKE..">
                                            ...
                                            <tbody v-if="(datapesan == 'data kosong')">
                                                <tr>
                                                    <td
                                                        :colspan="leveluser.includes(1) || leveluser.includes(2) ? 20 : (leveluser.includes(4) || leveluser.includes(6) || leveluser.includes(8) || leveluser.includes(9) || jenis_piusistem.includes(21, 6, 31) ? 15 : 10)">
...
export default {
    ...
    methods: {
        ...
        onChange3() {
            this.files3.push(...this.$refs.file3.files);
        },
        dragover(e) {
            e.preventDefault();
        ...
        dragover3(e) {
            ...
            document.getElementById('drag_drop3').style.borderColor = '#333';
        },
        dragleave() {
        ...
        dragleave3() {
            ...
            document.getElementById('drag_drop3').style.borderColor = '#ccc';
        },
        drop(e) {
            e.preventDefault();
        ...
        remove3(i) {
            ...
            if (this.files3.length === 0 && this.$refs.file3) {
        ...
        upload3() {
            ...
            files.forEach((file) => {
                ...
                if(file.status != 100){
                    ...
                    mainAPI.post("parastapainnovationimg-FilesUpload", fd, {
                        onUploadProgress: function (uploadEvent) {
                            document.getElementById('persennyapic3' + files.indexOf(file)).style.width = Math.round((uploadEvent.loaded / uploadEvent.total) * 100) + "%";
                            document.getElementById('tulisanpersenpic3' + files.indexOf(file)).innerHTML = Math.round((uploadEvent.loaded / uploadEvent.total) * 100) + "%";
                        }
                    }).then(
                        Response => {
                            document.getElementById('suksesnyapic3' + files.indexOf(file)).innerHTML = Response.data.message;
                            if (Response.data.filename != undefined) {
                                document.getElementById('pic3' + files.indexOf(file)).value = Response.data.filename;
                            }
                        }

                    ).catch(function (e) {
                        document.getElementById('suksesnyapic3' + files.indexOf(file)).innerHTML = Response.data.message;
                        document.getElementById('pic3' + files.indexOf(file)).value = '';
                        //console.log(e);
                    }
                    )
                }
        ...
        async AmbilDataReff() {
            ...
            await mainAPIData.get("parastapainnovationreff-GetMasterSatkerEvaluasiPusat?random=" + random + "&iduser=" + this.iduser).then(
                Response => {
        ...
        async ambildata() {
            ...
            if (this.leveluser.includes(4) || this.leveluser.includes(6) || this.leveluser.includes(8) || this.leveluser.includes(9)) {
                var pelaksana = this.kode_satker;
            }

            await mainAPI.get("masterlke-GetAllPenilaianLKEPusat?random=" + random + "&tahun=" + this.selectedtahun + "&id_user=" + pelaksana + "&level=" + this.leveluser).then(
                Response => {
                    this.datapesan = Response.data.message;
                    ...
                    if (this.datapesan == 'data diketemukan') {
                        ...
                        this.skor_lke   = Response.data.content.total_hasil_evaluasi;
                    }
                    else {
                        this.datamaster = [];
                        this.skor_lke = 0;
            ...
            this.halamanloading = true;
            await mainAPI.get("penilaianlke-GetSummaryPenilaianLKEPusat?random=" + random + "&tahun=" + this.selectedtahun + "&id_user=" + pelaksana + "&level=" + this.leveluser).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
        ...
        simpan() {
            if (this.mode == 'Tambah') {
                ...
                for (let i = 0; i < this.files.length; i++) {
                    if (i == 0) {
                        ...
                        nama_file = nama_file + document.getElementById('nama_file' + i).value;
                    }
                    else {
                        tempfiles = tempfiles + ',' + document.getElementById('pic' + i).value;
                        nama_file = nama_file + ',' + document.getElementById('nama_file' + i).value;
                ...
                fd.append("nama_file_dok", nama_file);
            ...
            else if(this.mode == 'EditBuktiDukung'){
                if ((this.selectedtahun == '') || (this.selectedtahun == null) || (this.selectedtahun == undefined)) {
                    swal.mixin({
                        toast: true,
                        position: 'top-end',
                ...
                if (this.files3.length == 0) {
                    ...
                    document.getElementById('drag_drop3').focus();
                    return false;
                }

                var tempfiles = '';
                var nama_file = '';
                // alert(this.files3.length);
                // return false;
                for (let i = 0; i < this.files3.length; i++) {
                    if (i == 0) {
                        tempfiles = tempfiles + document.getElementById('pic3' + i).value;
                        nama_file = nama_file + document.getElementById('nama_file3' + i).value;
                    }
                    else {
                        tempfiles = tempfiles + ',' + document.getElementById('pic3' + i).value;
                        nama_file = nama_file + ',' + document.getElementById('nama_file3' + i).value;
                ...
                mainAPI.post("masterlke-EditBuktiDukungLKE", fd).then(
                    Response => {
                        if (Response.data.response == 'error') {
                            swal.fire('Peringatan', Response.data.message, 'error');
                        }
                            ...
                            swal.fire('Informasi', 'Data telah tersimpan..', 'success').then(() => {
                                $('#costumModalEditBuktiDukung').modal('hide');
                ...
                fd.append("id_lke", this.id_lke);
                fd.append("tahun", this.selectedtahun);
                fd.append("id_evaluator", this.iduser);
        ...
        prosesdata(id, id_lke, mode) {
            ...
            if (this.mode == 'Tambah') {
                ...
                swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        const data = { id_kriteria: this.id, tahun: this.selectedtahun, id_user: this.iduser, kode_satker: this.kode_satker, level: this.leveluser, letedby: JSON.parse(localStorage.getItem("usistem")) }
                        const mainAPI = axios.create({
                            baseURL: process.env.VUE_APP_URL_API + this.tahunku + '/',
                            headers: {
                                Authorization: "Bearer " + localStorage.getItem("tokensistem"),
                            ...
                            Response => {
                                if (Response.data.response == 'error') {
                                    ...
                                    swal.fire('Informasi', 'Data telah direset..', 'success').then(function () {
                                        window.location.replace("/InputLKE");
                                    });
                                }
                            }
                        ).catch(
            ...
            else if(this.mode == 'NilaiIndikator'){
                swal.fire({
                    title: "Konfirmasi",
                    text: "Yakin Hendak menilai Indikator dengan nilai 0?",
                    icon: "warning",
                    showCancelButton: true,
                    cancelButtonText: "Batal",
                    confirmButtonColor: "#003d68",
                    ...
                    if (result.isConfirmed) {
                        ...
                        mainAPI.post("masterlke-nilaiIndikatorLKEPusat", data).then(
                            Response => {
                                if (Response.data.response == 'error') {
                                    swal.fire('Peringatan', Response.data.message, 'error');
                                }
                                else {
                                    swal.fire('Informasi', 'Data telah dinilai..', 'success').then(function () {
                                        window.location.replace("/InputLKE");
                                    });
                                }
                            }
            ...
            else if(this.mode == 'LihatBuktiDukung'){
                this.isiandata = [];
                this.halamanloading = true;
                const mainAPI = axios.create({
                    baseURL: process.env.VUE_APP_URL_API + this.tahunku + '/',
                ...
                var random = Math.random();
                mainAPI.get("masterlke-getKriteriaLKEbyID?random=" + random + "&tahun=" + this.selectedtahun + "&id_kriteria=" + this.id + "&id_user=" + this.iduser + "&id_lke=" + this.id_lke).then(
                    Response => {
                        this.datapesan = Response.data.message;
                        if (this.datapesan == 'data diketemukan') {
                            this.isiandata = [];
                        ...
                        $('#costumModalLihatBuktiDukung').modal('show');
                        this.halamanloading = false;
                    }
                ).catch(error => {
                    console.log(error);
                ...
                mainAPI.get("masterlke-getKriteriaLKEbyID?random=" + random + "&tahun=" + this.selectedtahun + "&id_kriteria=" + this.id + "&id_user=" + this.iduser + "&id_lke=" + this.id_lke).then(
                    Response => {
                        ...
                        if (this.datapesan == 'data diketemukan') {
                            this.files3 = [];
                            this.files3 = Response.data.content.data;
                        }
                        else {
                            this.files3 = [];
                        }
                        $('#costumModalEditBuktiDukung').modal('show');
                        this.halamanloading = false;
                    }
                ).catch(error => {
                    console.log(error);
            ...
            else if(this.mode == 'ResetEvaluasiDataLKE'){
                
                swal.fire({
                    title: "Konfirmasi",
                    text: "Yakin Hendak Reset Evaluasi Data LKE?",
                    icon: "warning",
                    showCancelButton: true,
                    cancelButtonText: "Batal",
                    confirmButtonColor: "#003d68",
                    ...
                    if (result.isConfirmed) {
                        ...
                        mainAPI.post("penilaianlke-ResetPenilaianLKE", data).then(
                            Response => {
                                if (Response.data.response == 'error') {
                                    swal.fire('Peringatan', Response.data.message, 'error');
                                }
        ...
        exportWord() {
            ...
            mainAPI.get("penilaianlke-ExportWordLHEPusat?random=" + random + "&tahun=" + this.selectedtahun + "&id_user=" + this.selectedsatker + "&level=" + this.leveluser + "&kode_satker_evaluator=" + this.kode_satker).then(
                response => {
        ...
        exportWordBA() {
            ...
            mainAPI.get("penilaianlke-ExportWordBAPusat?random=" + random + "&tahun=" + this.selectedtahun + "&id_user=" + this.selectedsatker + "&level=" + this.leveluser + "&id_evaluator=" + this.id_evaluator + "&kode_satker_evaluator=" + this.kode_satker + "&kategori_satker=" + this.ksatkersistem).then(
                response => {
                    // Buat link download dari blob
                    const url = window.URL.createObjectURL(new Blob([response.data]));
                    const link = document.createElement('a');
        ...
        exportExcel() {
            ...
            mainAPI.get("penilaianlke-ExportExcelLKEPusat?random=" + random + "&tahun=" + this.selectedtahun + "&id_user=" + this.selectedsatker + "&level=" + this.leveluser).then(
                response => {
                    // Buat link download dari blob
                    const url = window.URL.createObjectURL(new Blob([response.data]));
                    const link = document.createElement('a');
