                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 wow fadeInDown">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Tim Evaluatan</li>
                            </ol>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                        ...
                                        <table class="table m-0" id="tabeldata">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 150px;">Nama Tim Evaluatan</th>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <button type="button"
                                                                ...
                                                                @click="prosesdata(datalist.id_evaluatan)"
                                                            ...
                                                            <button type="button"
                                                                ...
                                                                @click="hapus(datalist.id_evaluatan)"
                                                                data-toggle="tooltip" data-placement="left"
                                                                title="Hapus data..">
...
export default {
    ...
    methods: {
        ...
        async pindahhalaman(halamannya) {
            ...
            await mainAPI.get("masterlke-GetAllEvaluatan?random=" + random + "&iduser=" + this.kode_satker + "&level=" + this.leveluser + "&halaman=" + halamannya + "&cari=" + this.carikata).then(
                Response => {
        ...
        async ambildata() {
            ...
            var random = Math.random();
            await mainAPI.get("masterlke-GetAllEvaluatan?random=" + random + "&iduser=" + this.kode_satker + "&level=" + this.leveluser + "&halaman=" + this.halaman + "&cari=" + this.carikata).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
                        this.datamaster = [];
        ...
        prosesdata(kode) {
            ...
            window.location.replace("/ProsesEvaluatan/" + bytes);
        },
        hapus(kode) {
            swal.fire({
                title: "Konfirmasi",
                ...
                if (result.isConfirmed) {
                    ...
                    mainAPI.post("masterlke-DeleteEvaluatan", data).then(
                        Response => {
