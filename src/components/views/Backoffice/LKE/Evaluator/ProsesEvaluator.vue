                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 wow fadeInDown">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="/Evaluator">Evaluator</a></li>
                                <li class="breadcrumb-item active">Form Input Evaluator</li>
                            </ol>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-sm-12 wow fadeInDown">
                            <div class="card cardputih">
                                <div class="card-header border-transparent">
                                    <h3 class="card-title">Form Input Evaluator</h3>
                                ...
                                <div class="card-body p-3">
                                    <div class="row">
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm" id="tim"
                                                    name="tim" placeholder="Nama Tim Evaluator" v-model="tim">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-12">
                                            <label>Pilih Data Tahun <small class="text-info"> (*wajib
                                                    diisi)</small></label>
...
export default {
    ...
    methods: {
        ...
        async AmbilDataSingel() {
            ...
            await mainAPIDataSingel.get("masterlke-EditEvaluator?id=" + this.secretencData + "&random=" + random).then(
                Response => {
                    ...
                    if (this.datapesan == 'data diketemukan') {
                        ...
                        this.selectedtahun = Response.data.content.data[0].tahun_evaluasi;
        ...
        simpan() {
            ...
            fd.append("tahun_evaluasi", this.selectedtahun);
            ...
            mainAPI.post("masterlke-AddEvaluator", fd).then(
                Response => {
        ...
        update() {
            ...
            mainAPI.post("masterlke-UpdateEvaluator", fd).then(
                Response => {
                    if (Response.data.response == 'error') {
                        swal.fire('Peringatan', Response.data.message, 'error');
                    }
