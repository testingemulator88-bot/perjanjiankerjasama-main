                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 wow fadeInDown">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="/Komponen">Komponen</a></li>
                                <li class="breadcrumb-item active">Form Input Komponen</li>
                            </ol>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                        ...
                        <div class="col-sm-12 wow fadeInDown">
                            <div class="card cardputih">
                                <div class="card-header border-transparent">
                                    <h3 class="card-title">Form Input Komponen</h3>
                                        ...
                                        <div class="col-sm-12">
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm"
                                                    id="kode_komponen" name="kode_komponen" placeholder="Kode Komponen"
                                                    v-model="kode_komponen">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <label>
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm"
                                                    id="nama_komponen" name="nama_komponen" placeholder="Nama Komponen"
                                                    v-model="nama_komponen">
                                            </div>
                                        </div>
                                        <div class="col-sm-12">
                                            <label>
                                            ...
                                            <div class="input-group mb-3">
                                                ...
                                                <input type="text" class="form-control form-control-sm"
                                                    id="bobot_komponen" name="bobot_komponen" placeholder="Bobot"
                                                    v-model="bobot_komponen" @keypress="onlyNumberKey(event)"
...
export default {
    ...
    methods: {
        ...
        batalproses() {
            window.location.replace("/Komponen");
        },
        async AmbilDataSingel() {
            ...
            await mainAPIDataSingel.get("masterlke-EditKomponen?id=" + this.secretencData + "&random=" + random).then(
                Response => {
                    this.kode_komponen = Response.data.content.data[0].kode_komponen;
                    this.nama_komponen = Response.data.content.data[0].nama_komponen;
                    this.bobot_komponen = Response.data.content.data[0].bobot_komponen;
        ...
        validasidata() {
            if (document.getElementById('kode_komponen').value == '') {
                swal.mixin({
                    toast: true,
                    position: 'top-end',
                ...
                document.getElementById('kode_komponen').focus();
                return false;
            }
            if (document.getElementById('nama_komponen').value == '') {
                swal.mixin({
                    toast: true,
                    position: 'top-end',
                    showConfirmButton: false,
                ...
                document.getElementById('nama_komponen').focus();
                return false;
            }
            if (document.getElementById('bobot_komponen').value == '') {
                swal.mixin({
                    toast: true,
                    position: 'top-end',
                    showConfirmButton: false,
                ...
                document.getElementById('bobot_komponen').focus();
                return false;
            }
        ...
        simpan() {
            ...
            fd.append("kode_komponen", this.kode_komponen);
            fd.append("nama_komponen", this.nama_komponen);
            fd.append("bobot_komponen", this.bobot_komponen);
            ...
            mainAPI.post("masterlke-AddKomponen", fd).then(
                Response => {
        ...
        update() {
            ...
            mainAPI.post("masterlke-UpdateKomponen", fd).then(
                Response => {
                    if (Response.data.response == 'error') {
                        swal.fire('Peringatan', Response.data.message, 'error');
                    }
