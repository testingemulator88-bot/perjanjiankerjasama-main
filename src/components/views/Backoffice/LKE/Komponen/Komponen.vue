                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6 wow fadeInDown">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item active">Master Komponen</li>
                            </ol>
                        </div>
                    </div><!-- /.row -->
                </div><!-- /.container-fluid -->
                                        ...
                                        <table class="table m-0" id="tabeldata">
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 100px;">Kode Komponen</th>
                                                    <th style="width: 150px;">Nama Komponen</th>
                                                    <th style="width: 150px;">Bobot Komponen</th>
...
export default {
    ...
    methods: {
        ...
        async ambildata() {
            ...
            await mainAPI.get("masterlke-GetAllKomponen?random=" + random + "&level=" + this.leveluser).then(
                Response => {
        ...
        prosesdata(kode) {
            ...
            window.location.replace("/ProsesKomponen/" + bytes);
        },
        hapus(kode) {
            swal.fire({
                title: "Konfirmasi",
                ...
                if (result.isConfirmed) {
                    ...
                    mainAPI.post("masterlke-DeleteKomponen", data).then(
                        Response => {
