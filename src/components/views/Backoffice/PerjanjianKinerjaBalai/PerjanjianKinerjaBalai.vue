                                            ...
                                            <tr>
                                                <td class="text-center" :class="datalist.class" v-if="showOpsi">
                                                    <button type="button"
                                                        ...
                                                        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Edit
                                                        Data</button>
                                                    <button type="button" v-if="datalist.level == 'ISP' && ((!leveluser.includes(1) && (!leveluser.includes(2))))
                                                        && (jenis_piusistem != 34) && (jenis_piusistem != 36) && (jenis_piusistem != 37) && (jenis_piusistem != 38)
                                                        && (jenis_piusistem != 42) && (jenis_piusistem != 43) && (jenis_piusistem != 44)
                                                        && hasilakhir.includes('Selesai') && shortcutinput == '0'"
    ...
    methods: {
            ...
            await mainAPI.get("pksatker-DataVerif?random=" + random + "&kode_satker=" + kode_satker + "&tahun=" + this.selectedtahun + "&pelaksana=" + jenis_satker).then(
                Response => {
                    ...
                    if (this.datapesanreff == 'data diketemukan') {
                        ...
                        document.getElementById('iframefileverifikasi').src = process.env.VUE_APP_URL_API + this.tahunku + '/' + "pkbalai-cetakPK?kodebalai=" + btoa(pelaksana) + "&tahun=" + btoa(this.selectedtahun) + "&pelaksana=" + btoa(pelaksana);
        ...
        lihatdetail(id, hitungan_pk) {
            ...
            if (this.hitungan_pk == 1) {
                var random = Math.random();
                mainAPI.get("pkbalai-GetBaseline?random=" + random + "&tahun=" + this.selectedtahun + "&id=" + this.id + "&kdbalai=" + this.selectedkategorisatker + "&hitungan_pk=" + this.hitungan_pk).then(
                    Response => {
                ...
                var random = Math.random();
                mainAPI.get("pkbalaihitungan-GetBaseline?random=" + random + "&tahun=" + this.selectedtahun + "&id=" + this.id + "&kdbalai=" + this.selectedkategorisatker + "&hitungan_pk=" + this.hitungan_pk).then(
                    Response => {
                        this.datapesan = Response.data.message;
                        if (this.datapesan == 'data diketemukan') {
                            this.isiandata = [];
        ...
        cetakpk() {
            ...
            if (kategorisatker == 1) {
                ...
                document.getElementById('iframefile').src = process.env.VUE_APP_URL_API + this.tahunku + '/' + "pkbalai-cetakPK?kodebalai=" + btoa(kategorisatker) + "&tahun=" + btoa(this.selectedtahun);
            }
        ...
        simpan() {
            ...
            mainAPI.post("pkbalai-Update", fd).then(
                Response => {
                    ...
                    if (Response.data.response == 'error') {
                        ...
                        swal.fire('Informasi', 'Data telah tersimpan..', 'success').then(function () {
                            window.location.replace("/PerjanjianKinerjaBalai/" + kode);
                        });
                    }
                }
            ).catch(function (error) {
        ...
        async ambildata() {
            ...
            await mainAPI.get("pkbalai-GetData?random=" + random + "&tahun=" + this.selectedtahun + "&kodebalai=" + kategorisatker).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
                        this.datamaster = [];
            ...
            this.halamanloading = true;
            var random = Math.random();
            await mainAPI.get("pkbalai-GetTTD?random=" + random + "&kode_satker=" + kategorisatker).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
