                                        ...
                                        <table class="table m-0" :id="'tabeldata' + urutkolom"
                                            ...
                                            <thead>
                                                <tr>
                                                    ...
                                                    <th style="width: 10px;">
                                                        Capaian Output<br>(<span v-html="namaoutput"></span>)
                                                    </th>
                                                    <th style="width: 50px;" colspan="2">
                                                        Paket<br>eMon<br>(Jumlah)
                                                        <br>
                                            ...
                                            <template v-for="(dataisian, urutisian) in isiandata" :key="urutisian">
                                                <tr>
                                                    ...
                                                    <td class="text-left levelsubsubkegiatan" colspan="3"></td>
                                                </tr>
                                            </template>
                                            <template v-for="(dataisiandetail, urutisiandetail) in isiandatadetail"
                                                ...
                                                <tr>
                                                    ...
                                                    <template v-for="(isi, urutisi) in dataisiandetail.detail">
                                                        ...
                                                        <td class="text-center leveldetailsubunitpekerjaan">
                                                            <input type="text" class="form-control form-control-sm"
                                                                :id="'capaian' + dataisiandetail.tahun"
                                                                :name="'capaian' + dataisiandetail.tahun"
                                                                placeholder="Capaian" :value="isi.capaian"
                                                                @keyup="formattulisrupiah('capaian' + dataisiandetail.tahun)"
                                                                @keydown="formattulisrupiah('capaian' + dataisiandetail.tahun)"
                                                                readonly
                                                                style="border: solid 1px #778899;height: 20px !important;font-size: 11px !important;">
                                                        </td>
                                                ...
                                                <template v-for="(emon, urutemon) in dataisiandetail.dataemon"
                                                    ...
                                                    <tr :id="'baris' + emon.id">
                                                        ...
                                                        <td class="text-center " style="font-size: x-small !important;">
                                                            <input type="text" class="form-control form-control-sm"
                                                                :id="'capaian' + emon.tahun + emon.id"
                                                                :name="'capaian' + emon.tahun" placeholder="Capaian"
                                                                :value="emon.capaian"
                                                                :disabled="emon.tahun != tahunsekarang || disabelkolomnya"
                                                                @keyup="formattulisrupiah('capaian' + emon.tahun + emon.id)"
                                                                @keydown="formattulisrupiah('capaian' + emon.tahun + emon.id)"
                                                                style="border: solid 1px #778899;height: 20px !important;font-size: 11px !important;"
                                                                @change="ubahisian_outcome_target(emon.id, 'capaian', 'capaian' + emon.tahun + emon.id, emon.tahun)">
                                                        </td>
                                                        <td class=""
                                    ...
                                    <table class="table m-0" id="tabeldata" v-if="hitungan_pk == 1">
                                        <thead v-if="hitungan_pk == 1">
                                            <tr>
                                                ...
                                                <th style="width: 10px;" v-if="hitungan_pk == 1">
                                                    Capaian Target / Output<br>(<span v-html="namaoutput"></span>)</th>
                                                <th style="width: 10px;" v-if="hitungan_pk == 1">
                                                    Capaian Outcome<br>(<span v-html="namaoutcome"></span>)</th>
                                                <th style="width: 100px;" v-if="hitungan_pk == 1">
                                                    Paket<br>eMon<br>(Jumlah)
                                                    <br>
                                                    <input type="checkbox" id="custompilihan"
                                        ...
                                        <template v-for="(dataisiandetail, urutisiandetail) in isiandatadetail"
                                            ...
                                            <tr>
                                                ...
                                                <template v-for="(isi, urutisi) in dataisiandetail.detail"
                                                    ...
                                                    <td class="text-center leveldetailsubunitpekerjaan">
                                                        <input type="text" class="form-control form-control-sm"
                                                            :id="'capaian_outcome' + dataisiandetail.tahun"
                                                            :name="'capaian_outcome' + dataisiandetail.tahun"
                                                            placeholder="Capaian Outcome" :value="isi.capaian_outcome"
                                                            @keyup="formattulisrupiah('capaian_outcome' + dataisiandetail.tahun)"
                                                            @keydown="formattulisrupiah('capaian_outcome' + dataisiandetail.tahun)"
                                                            readonly
                                                            style="border: solid 1px #778899;height: 20px !important;font-size: 11px !important;">
                                                    </td>
                                                    <td class="text-center leveldetailsubunitpekerjaan">
                                            ...
                                            <template v-for="(emon, urutemon) in dataisiandetail.dataemon"
                                                ...
                                                <tr :id="'baris' + emon.id">
                                                    ...
                                                    <td class="text-center " style="font-size: x-small !important;">
                                                        <input type="text" class="form-control form-control-sm"
                                                            :id="'capaian_outcome' + emon.tahun + emon.id"
                                                            :name="'capaian_outcome' + emon.tahun"
                                                            placeholder="Capaian Outcome" :value="emon.capaian_outcome"
                                                            :disabled="emon.tahun != tahunsekarang || disabelkolomnya"
                                                            @keyup="formattulisrupiah('capaian_outcome' + emon.tahun + emon.id)"
                                                            @keydown="formattulisrupiah('capaian_outcome' + emon.tahun + emon.id)"
                                                            style="border: solid 1px #778899;height: 20px !important;font-size: 11px !important;"
                                                            @change="ubahisian_outcome_target(emon.id, 'capaian_outcome', 'capaian_outcome' + emon.tahun + emon.id, emon.tahun)">
                                                    </td>
                                                    <td class="" style="font-size: x-small !important;">
                                                        <input type="number" class="form-control form-control-sm"
                                                            :id="'latitude' + emon.tahun + emon.id"
                                        ...
                                        <template v-for="(dataisianemon, urutemon) in filteredKataData" :key="urutemon">
                                            <tbody class="mailbox-messages">
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        {{ (dataisianemon.persenkeu) }}
                                                    </td>
                                                    <td class="text-center">
                                                        {{ (dataisianemon.persenfisik) }}
                                                    </td>
                                                    <td class="text-center">
                                                        {{ dataisianemon.vol }}
                                                    </td>
                                ...
                                <table class="table m-0" id="tabeldata" style="font-size: smaller;">
                                    <thead>
                                        <tr>
                                            ...
                                            <th style="width: 300px;" v-if="showIndikator">
                                                PROGRAM/SASARAN
                                            ...
                                            <th style="width: 50px;" v-if="showCapaian">CAPAIAN<br>OUTPUT<br></br>(Tahun
                                                Berjalan)
                                            </th>
                                            <th style="width: 50px;" v-if="showCapaian">
                                                CAPAIAN<br>OUTCOME<br></br>(Tahun
                                                Berjalan)
                                            </th>
                                        </tr>
                                    </thead>
                                    <template v-for="(datalist, urutlist) in datamaster" :key="urutlist">
                                        <tbody>
                                            <tr>
                                                ...
                                                <td class="text-left" :class="datalist.class" v-if="showCapaian">
                                                    <span v-if="datalist.level == 'IKSK' && datalist.hitungan_pk == 1">
                                                        {{ datalist.capaian_outcome }}
                                                    </span>
                                                    &nbsp;<span v-html="datalist.namaoutcome"
                                                        v-if="datalist.hitungan_pk == 1"></span>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </template>
    ...
    methods: {
        ...
        hapusmultitaggingemon() {
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    mainAPI.post("pksatkerakhir-HapusMultiTagging", data).then(
                        Response => {
                        ...
                        Response => {
                            ...
                            if (Response.data.response == 'error') {
                                ...
                                if ((this.id_pelaksana_verif == '2') && (this.selectedverifikasi == '1') && (this.dari == '43')) {
                                    ...
                                    mainAPI2.post("pksatkerakhir-VerifUpdate", data2).then(
                                        Response => {
                                            if (Response.data.response == 'error') {
                                                swal.fire('Peringatan', Response.data.message, 'error');
                                            }
                                                ...
                                                swal.fire({
                                                    ...
                                                    window.location.replace("/PerjanjianKinerjaSatkerAkhir/" + kode);
                                                });
                                                $('.swal2-container').css("z-index", '999999');
                                            }
                                        }
            ...
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    if (dari == 42 && kepada == 2) {
                        ...
                        mainAPI.post("pksatkerakhir-AjukanKeIrwaVerif", data).then(
                            Response => {
                        ...
                        mainAPI.post("pksatkerakhir-AjukanKeSupanVerif", data).then(
                            Response => {
                                if (this.leveluser.includes(3) || this.leveluser.includes(4) || this.leveluser.includes(9) || this.leveluser.includes(8)) {
                                    var kode = encodeURIComponent(CryptoJS.AES.encrypt(this.secretencData, 'GPMop8LQ06S0rZXcJyEH3wk8jVrINbHwn7tBq2').toString());
                                }
                        ...
                        //alert(this.levpiusistem);
                        //alert(this.verifsistem);
                        //alert(this.verif2sistem);
                        //alert(ke);
                        //alert(kode_satker);
                        //alert(pelaksana);
                        //return;
        ...
        async verifpk() {
            ...
            if ((this.verifsistem != null && this.verifsistem.includes(pelaksana)) && this.leveluser != 1) {
                ...
                await mainAPI.get("pksatkerakhir-DataVerif?random=" + random + "&kode_satker=" + kode_satker + "&tahun=" + this.selectedtahun + "&pelaksana=" + pelaksana).then(
                    Response => {
                        ...
                        if (this.datapesanreff == 'data diketemukan') {
                            ...
                            document.getElementById('iframefile').src = process.env.VUE_APP_URL_API+this.tahunku+'/' + "pksatkerakhir-cetakPK?kode_satker=" + btoa(kode_satker) + "&tahun=" + btoa(this.selectedtahun) + "&pelaksana=" + btoa(pelaksana);
        ...
        cetakpk() {
            ...
            //alert(process.env.VUE_APP_URL_API+this.tahunku+'/' + foldernya + '?f=' + filenya);
            document.getElementById('iframefilecetak').src = process.env.VUE_APP_URL_API+this.tahunku+'/' + "pksatkerakhir-cetakPK?kode_satker=" + btoa(kode_satker) + "&tahun=" + btoa(this.selectedtahun) + "&pelaksana=" + btoa(pelaksana);
        ...
        ubahisian_outcome_target_persen(id, kolom, idisian, tahun, jumlah, urutan) {
            ...
            mainAPI.post("pksatkerakhirpersen-LatLongUpdate", data).then(
                Response => {
        ...
        ubahisian_outcome_target(id, kolom, idisian, tahun) {
            ...
            mainAPI.post("pksatkerakhir-LatLongUpdate", data).then(
                Response => {
                    ...
                    if (kolom == 'capaian') {
                        document.getElementById('capaian' + tahun).value = Response.data.jumlahnya;
                    }
                    if (kolom == 'capaian_outcome') {
                        document.getElementById('capaian_outcome' + tahun).value = Response.data.jumlahnya;
                    }
                    //alert(JSON.stringify(Response.data.jumlahnya));
                    if (Response.data.response == 'error') {
                        swal.fire('Peringatan', Response.data.message, 'error');
        ...
        async ambildata() {
            ...
            await mainAPI.get("pksatkerakhir-GetData?random=" + random + "&tahun=" + this.selectedtahun + "&pelaksana=" + pelaksana + "&kode_satker=" + kode_satker).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
                        this.datamaster = [];
            ...
            this.halamanloading = true;
            var random = Math.random();
            await mainAPI.get("pksatkerakhir-GetTTD?random=" + random + "&kode_satker=" + kode_satker).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
        ...
        prosesdata(id, namasatuan, namaoutput, namaoutcome, hitungan_pk, textindikator, jumlahkomponen, kolomkomponen, bobotkomponen, rumuskomponen, disabelkolomnya) {
            ...
            //alert(this.id);
            //alert(kode_satker);
            mainAPI.get("pksatkerakhir-GetBaseline?random=" + random + "&tahun=" + this.selectedtahun + "&id=" + this.id + "&kode_satker=" + kode_satker + "&hitungan_pk=" + this.hitungan_pk + "&textindikator=" + this.textindikator).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
                        this.isiandata = [];
        ...
        pilihemon() {
            ...
            mainAPI.post("pksatkerakhir-TaggingEmon", fd).then(
                Response => {
                ...
                if (this.hitungan_pk == 1) {
                    ...
                    for (let i = this.tahun_awal; i <= this.tahun_akhir; i++) {
                        ...
                        if (x == 1) {
                            ...
                            capaian = capaian + document.getElementById('capaian' + i).value;
                            capaian_outcome = capaian_outcome + document.getElementById('capaian_outcome' + i).value;
                        }
                        else {
                            proyek = proyek + '|' + document.getElementById('proyek' + i).innerHTML;
                            volume = volume + '|' + document.getElementById('volume' + i).value;
                    ...
                    fd.append("capaian", capaian);
                    fd.append("capaian_outcome", capaian_outcome);
                    fd.append("createdby", JSON.parse(localStorage.getItem("usistem")));
                    const mainAPI = axios.create({
                        baseURL: process.env.VUE_APP_URL_API+this.tahunku+'/',
                        headers: {
                    ...
                    mainAPI.post("pksatkerakhir-Update", fd).then(
                        Response => {
                        ...
                        if (i == 0) {
                            for (let z = this.tahun_awal; z <= this.tahun_akhir; z++) {
                                if (z == this.tahun_awal) {
                                    capaian = capaian + document.getElementById('capaian' + z).value;
        ...
        hapus(id) {
            swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    mainAPI.post("indikatorAkhir-Delete", data).then(
                        Response => {
                            if (Response.data.response == 'error') {
                                swal.fire('Peringatan', Response.data.message, 'error');
                            }
