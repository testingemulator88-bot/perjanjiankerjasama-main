    ...
    methods: {
            ...
            await mainAPI.get("pksatkerakhir-DataVerif?random=" + random + "&kode_satker=" + kode_satker + "&tahun=" + this.selectedtahun + "&pelaksana=" + jenis_satker).then(
                Response => {
                    ...
                    if (this.datapesanreff == 'data diketemukan') {
                        ...
                        document.getElementById('iframefileverifikasi').src = process.env.VUE_APP_URL_API + this.tahunku + '/' + "pkdirjenakhir-cetakPK?kodebalai=" + btoa(pelaksana) + "&tahun=" + btoa(this.selectedtahun) + "&pelaksana=" + btoa(pelaksana);
        ...
        lihatdetail(id, hitungan_pk) {
            ...
            if (this.hitungan_pk == 1) {
                var random = Math.random();
                mainAPI.get("pkdirjenakhir-GetBaseline?random=" + random + "&tahun=" + this.selectedtahun + "&id=" + this.id + "&kdbalai=" + this.selectedkategorisatker + "&hitungan_pk=" + this.hitungan_pk).then(
                    Response => {
                ...
                var random = Math.random();
                mainAPI.get("pkdirjenakhirhitungan-GetBaseline?random=" + random + "&tahun=" + this.selectedtahun + "&id=" + this.id + "&kdbalai=" + this.selectedkategorisatker + "&hitungan_pk=" + this.hitungan_pk).then(
                    Response => {
                        this.datapesan = Response.data.message;
                        if (this.datapesan == 'data diketemukan') {
                            this.isiandata = [];
        ...
        simpan() {
            ...
            mainAPI.post("pkdirjenakhir-Update", fd).then(
                Response => {
                    ...
                    if (Response.data.response == 'error') {
                        ...
                        swal.fire('Informasi', 'Data telah tersimpan..', 'success').then(function () {
                            window.location.replace("/PerjanjianKinerjaAkhir/" + kode);
                        });
                    }
                }
            ).catch(function (error) {
        ...
        async ambildata() {
            ...
            await mainAPI.get("pkdirjenakhir-GetData?random=" + random + "&tahun=" + this.selectedtahun + "&kodebalai=" + kategorisatker).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
                        this.datamaster = [];
            ...
            this.halamanloading = true;
            var random = Math.random();
            await mainAPI.get("pkdirjenakhir-GetTTD?random=" + random + "&kode_satker=" + kategorisatker).then(
                Response => {
                    this.datapesan = Response.data.message;
                    if (this.datapesan == 'data diketemukan') {
